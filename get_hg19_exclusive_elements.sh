...
bedtools complement -i parsed_promoters.merged.bed -g ../hg19.chrom.sizes > non_promoters.bed
bedtools intersect -a parsed_exons.merged.bed -b non_promoters.bed > np_exons.bed

bedtools complement -i parsed_exons.merged.bed -g ../hg19.chrom.sizes > non_exons.bed
...
bedtools complement -i parsed_introns.merged.bed -g ../hg19.chrom.sizes > non_introns.bed
